...
ULProperty<bool, NMazeMemory_simplified, ptPubParameter> Situation;
...
ULProperty<std::vector<int>,NMazeMemory_simplified, ptPubParameter> InputActions;

///Тип нейронов действия
RDK::ULProperty<string, NMazeMemory_simplified, ptPubParameter> ActionNeuronsType;

/// Количество признаков, описывающих запоминаемую ситуацию
ULProperty<int, NMazeMemory_simplified, ptPubParameter> FeaturesNum;

/// Флаг завершения работы (все возможные варианты исследованы)
ULProperty<bool, NMazeMemory_simplified, ptPubParameter> IsDone;

///Вектор параметров ситуации (сейчас = {x,y,alpha}, где alpha - ориентация робота
ULProperty<MDMatrix<double>, NMazeMemory_simplified, ptPubParameter> SituationCoords;
