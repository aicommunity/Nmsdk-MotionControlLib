...
protected: // Данные
 ...
 std::vector<std::shared_ptr <NPulseGeneratorMulti>> KFClsSpikes;

 /// Генераторы тестовых спайковых образов классов
 std::vector<std::shared_ptr <NPulseGeneratorMulti>> FrClsSpikes;

 /// Сравнивающий нейрон
 std::shared_ptr <NPulseNeuron> CompNeuron;
