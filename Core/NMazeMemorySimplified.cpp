...
// --------------------------
NMazeMemorySimplified::NMazeMemorySimplified(void)
    : Situation("Situation",this, &NMazeMemorySimplified::SetSituation),
    InputActions("InputActions",this, &NMazeMemorySimplified::SetInputActions),
    ActionNeuronsType("ActionNeuronsType",this, &NMazeMemorySimplified::SetActionNeuronsType),
    FeaturesNum("FeaturesNum",this, &NMazeMemorySimplified::SetFeaturesNum),
    IsDone("IsDone",this, &NMazeMemorySimplified::SetIsDone),
    SituationCoords("SituationCoords",this, &NMazeMemorySimplified::SetSituationCoords)
//IsDeadlock("IsDeadlock",this, &NMazeMemorySimplified::SetIsDeadlock)
...
// --------------------------
bool NMazeMemorySimplified::SetSituation(const bool &value)
{
    return true;
}

bool NMazeMemorySimplified::SetInputActions(const std::vector<int> &value)
{
    return true;
}

bool NMazeMemorySimplified::SetActionNeuronsType(const string &value)
{
    return true;
}

bool NMazeMemorySimplified::SetFeaturesNum(const int &value)
{
...
bool NMazeMemorySimplified::SetIsDone(const bool &value)
{
    return true;
}

bool NMazeMemorySimplified::SetSituationCoords(const MDMatrix<double> &value)
{
...
NMazeMemorySimplified* NMazeMemorySimplified::New(void)
{
    return new NMazeMemorySimplified;
}

UComponent* NMazeMemorySimplified::NewStatic(void)
{
    return new NMazeMemorySimplified;
}
// --------------------------
...
bool NMazeMemorySimplified::AAddComponent(UEPtr<UContainer> comp, UEPtr<UIPointer> pointer)
{
...
bool NMazeMemorySimplified::ADelComponent(UEPtr<UContainer> comp)
{
...
bool NMazeMemorySimplified::AReset(void)
{
...
bool NMazeMemorySimplified::ADefault(void)
{
    Situation = false;
...
bool NMazeMemorySimplified::ABuild(void)
{
...
bool NMazeMemorySimplified::ACalculate(void)
{
    if(IsNotFinished)
    {
...
UEPtr<NTrajectoryElement> NMazeMemorySimplified::CreatePoint(MVector<double,3> coords)
{
...
bool NMazeMemorySimplified:: LinkPoint(UEPtr<NTrajectoryElement> traj_el,  MVector<double,3> base_coords, int options_num)
{
...
bool NMazeMemorySimplified::CheckActiveForwards(UEPtr<NTrajectoryElement> t_element)
{
...
int NMazeMemorySimplified::CheckActivePIs()
{
...
bool NMazeMemorySimplified::ProcessOptions()
{
...
bool NMazeMemorySimplified::LastUsedLink()
{
...
bool NMazeMemorySimplified::CallForResponse()
{
...
bool NMazeMemorySimplified::DeadlockProcessing()//ТРЕБУЕТ ОТЛАДКИ
{
