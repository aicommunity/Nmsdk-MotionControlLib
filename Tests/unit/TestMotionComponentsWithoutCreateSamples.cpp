...
class MotionControlLibBasicTest : public ::testing::Test {
protected:
    void SetUp() override {
        InitTestLogging();
...
TEST_F(MotionControlLibBasicTest, LibraryUploadsClasses) {
