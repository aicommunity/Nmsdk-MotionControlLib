...
UProperty<std::vector<string>, NTrajectoryElement, ptPubParameter> ForwardsNames;

/// Имена родительских TE (содержимое вектора Backwards)
UProperty<std::vector<string>, NTrajectoryElement, ptPubParameter> BackwardsNames;

/// Имена синапсов, на которые заведены связи на дочерние TE (содержимое вектора ForwardSyns)
UProperty<std::vector<string>, NTrajectoryElement, ptPubParameter> ForwardSynsNames;

/// Имена синапсов, на которые заведены обратные связи на родительские TE (содержимое вектора BackwardSyns)
UProperty<std::vector<string>, NTrajectoryElement, ptPubParameter> BackwardSynsNames;

///Имена всех узлов (СИНАПСЫ), в которые можно попасть из данного (содержимое вектора Paths)
UProperty<std::vector<string>, NTrajectoryElement, ptPubParameter> PathsNames;
...
/// (возможное действие)
///параметр необходим для использования в MazeMemory
UProperty<int, NTrajectoryElement, ptPubParameter> LastUsedForward;
...
///параметр необходим для использования в MazeMemory
UProperty<int, NTrajectoryElement, ptPubParameter> LastUsedBackward;
